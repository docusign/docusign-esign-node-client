...
describe('BillingApi Tests With Callbacks:', function (done) {
  ...
  describe('BillingApi tests:', function () {
        const billingPlanId = ''
        const billingApi = new docusign.BillingApi(apiClient);

        // it('Get Billing Plan', function (done) {
        ...
        //         done();
        //     }
        //     billingApi.getBillingPlan(billingPlanId, callback)
        // })
    })
});
