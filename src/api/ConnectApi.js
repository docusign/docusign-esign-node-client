...
###### Note: Connect must be enabled for your account to use this function.
    ...
    /**
     * (Optional) Callback function to receive the result of the getConnectSecret operation. If none specified a Promise will be returned.
     * @callback module:api/ConnectApi~getConnectSecretCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} If a callback was specified, the response The complete HTTP response, else a Promise resolving the response Data.
     */
     ...
     * @param {String} accountId The external account number (int) or account ID Guid.
     * @param {module:api/ConnectApi~getConnectSecretCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.getConnectSecret = function(accountId, callback) {
      var postBody = null;

      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling getConnectSecret");
      }
