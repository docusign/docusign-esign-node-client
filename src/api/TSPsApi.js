...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Docusign.TSPsApi = factory(root.Docusign.Configuration, root.Docusign.ApiClient, root.Docusign.CompleteSignHashResponse, root.Docusign.CompleteSignRequest, root.Docusign.ErrorDetails, root.Docusign.SignHashSessionInfoResponse, root.Docusign.SignSessionInfoRequest, root.Docusign.TspHealthCheckRequest, root.Docusign.UpdateTransactionRequest, root.Docusign.UpdateTransactionResponse, root.Docusign.UserInfoResponse);
  }
  ...
  /**
   * Constructs a new TSPsApi. 
   * @alias module:api/TSPsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/TSPsApi~completeSignHashCallback
     ...
     * @param {module:api/TSPsApi~completeSignHashCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/TSPsApi~getUserInfoCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/TSPsApi~getUserInfoCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/TSPsApi~healthCheckCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/TSPsApi~healthCheckCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/TSPsApi~signHashSessionInfoCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/TSPsApi~signHashSessionInfoCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/TSPsApi~updateTransactionCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/TSPsApi~updateTransactionCallback} callback The callback function, accepting three arguments: error, data, response
