...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
	...
	define(['Configuration', 'ApiClient', 'model/ErrorDetails', 'model/Notary', 'model/NotaryJurisdiction', 'model/NotaryJurisdictionList', 'model/NotaryResult'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../Configuration'), require('../ApiClient'), require('../model/ErrorDetails'), require('../model/Notary'), require('../model/NotaryJurisdiction'), require('../model/NotaryJurisdictionList'), require('../model/NotaryResult'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    root.Docusign.NotaryJurisdictionApi = factory(root.Docusign.Configuration, root.Docusign.ApiClient, root.Docusign.ErrorDetails, root.Docusign.Notary, root.Docusign.NotaryJurisdiction, root.Docusign.NotaryJurisdictionList, root.Docusign.NotaryResult);
  }
}(this, function(Configuration, ApiClient, ErrorDetails, Notary, NotaryJurisdiction, NotaryJurisdictionList, NotaryResult) {
  'use strict';

  /**
   * NotaryJurisdiction service.
   * @module api/NotaryJurisdictionApi
   * @version 3.0.0
   */

  /**
   * Constructs a new NotaryJurisdictionApi. 
   * @alias module:api/NotaryJurisdictionApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/NotaryJurisdictionApi~createNotaryCallback
     ...
     * @param {module:api/NotaryJurisdictionApi~createNotaryCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/NotaryJurisdictionApi~createNotaryJurisdictionsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/NotaryJurisdictionApi~createNotaryJurisdictionsCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/NotaryJurisdictionApi~deleteNotaryJurisdictionCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/NotaryJurisdictionApi~deleteNotaryJurisdictionCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/NotaryJurisdictionApi~getNotaryCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/NotaryJurisdictionApi~getNotaryCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/NotaryJurisdictionApi~getNotaryJurisdictionCallback
     * @param {String} error Error message, if any.
     * @param {module:model/NotaryJurisdiction} data The data returned by the service call.
     * @param {String} If a callback was specified, the response The complete HTTP response, else a Promise resolving the response Data.
     */
     ...
     * @param {String} jurisdictionId 
     * @param {module:api/NotaryJurisdictionApi~getNotaryJurisdictionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/NotaryJurisdiction}
     */
     ...
     * @callback module:api/NotaryJurisdictionApi~getNotaryJurisdictionSealCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} If a callback was specified, the response The complete HTTP response, else a Promise resolving the response Data.
     */
     ...
     * @param {String} jurisdictionId 
     * @param {module:api/NotaryJurisdictionApi~getNotaryJurisdictionSealCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/NotaryJurisdictionApi~getNotaryJurisdictionsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/NotaryJurisdictionApi~getNotaryJurisdictionsCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/NotaryJurisdictionApi~updateNotaryCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Notary} data The data returned by the service call.
     * @param {String} If a callback was specified, the response The complete HTTP response, else a Promise resolving the response Data.
     */
     ...
     * @param {Object} optsOrCallback Optional parameters, if you are passing no optional parameters, you can either pass a null or omit this parameter entirely.
     * @param {module:model/Notary} optsOrCallback.notary 
     * @param {module:api/NotaryJurisdictionApi~updateNotaryCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Notary}
     */
     ...
     * @callback module:api/NotaryJurisdictionApi~updateNotaryJurisdictionCallback
     * @param {String} error Error message, if any.
     * @param {module:model/NotaryJurisdiction} data The data returned by the service call.
     * @param {String} If a callback was specified, the response The complete HTTP response, else a Promise resolving the response Data.
     */
     ...
     * @param {Object} optsOrCallback Optional parameters, if you are passing no optional parameters, you can either pass a null or omit this parameter entirely.
     * @param {module:model/NotaryJurisdiction} optsOrCallback.notaryJurisdiction 
     * @param {module:api/NotaryJurisdictionApi~updateNotaryJurisdictionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/NotaryJurisdiction}
     */
