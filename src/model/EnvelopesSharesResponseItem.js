...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Docusign.EnvelopesSharesResponseItem = factory(root.Docusign.ApiClient, root.Docusign.AuthorizationUser, root.Docusign.ErrorDetails);
  }
  ...
  /**
   * The EnvelopesSharesResponseItem model module.
   * @module model/EnvelopesSharesResponseItem
   */

  /**
   * Constructs a new <code>EnvelopesSharesResponseItem</code>.
   * @alias module:model/EnvelopesSharesResponseItem
   * @class
   */
  ...
  /**
   * Constructs a <code>EnvelopesSharesResponseItem</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EnvelopesSharesResponseItem} obj Optional instance to populate.
   * @return {module:model/EnvelopesSharesResponseItem} The populated <code>EnvelopesSharesResponseItem</code> instance.
   */
