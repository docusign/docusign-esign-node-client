...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BccEmailArchiveHistory'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BccEmailArchiveHistory'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    root.Docusign.BccEmailArchiveHistoryList = factory(root.Docusign.ApiClient, root.Docusign.BccEmailArchiveHistory);
  }
}(this, function(ApiClient, BccEmailArchiveHistory) {
  'use strict';


  /**
   * The BccEmailArchiveHistoryList model module.
   * @module model/BccEmailArchiveHistoryList
   */

  /**
   * Constructs a new <code>BccEmailArchiveHistoryList</code>.
   * @alias module:model/BccEmailArchiveHistoryList
   * @class
   */
  ...
  /**
   * Constructs a <code>BccEmailArchiveHistoryList</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BccEmailArchiveHistoryList} obj Optional instance to populate.
   * @return {module:model/BccEmailArchiveHistoryList} The populated <code>BccEmailArchiveHistoryList</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('bccEmailArchiveHistory')) {
        obj['bccEmailArchiveHistory'] = ApiClient.convertToType(data['bccEmailArchiveHistory'], [BccEmailArchiveHistory]);
      }
  ...
  /**
   * 
   * @member {Array.<module:model/BccEmailArchiveHistory>} bccEmailArchiveHistory
   */
  exports.prototype['bccEmailArchiveHistory'] = undefined;
  /**
