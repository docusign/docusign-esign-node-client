...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Docusign.CommissionCounty = factory(root.Docusign.ApiClient, root.Docusign.ErrorDetails, root.Docusign.LocalePolicyTab, root.Docusign.MergeField, root.Docusign.PropertyMetadata, root.Docusign.SmartContractInformation);
  }
}(this, (ApiClient, ErrorDetails, LocalePolicyTab, MergeField, PropertyMetadata, SmartContractInformation) => {
  /**
   * The CommissionCounty model module.
   * @module model/CommissionCounty
   */

  /**
   * Constructs a new <code>CommissionCounty</code>.
   * @alias module:model/CommissionCounty
   * @class
   */
  ...
  /**
   * Constructs a <code>CommissionCounty</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CommissionCounty} obj Optional instance to populate.
   * @return {module:model/CommissionCounty} The populated <code>CommissionCounty</code> instance.
   */
