...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Docusign.CommissionNumber = factory(root.Docusign.ApiClient, root.Docusign.ErrorDetails, root.Docusign.LocalePolicyTab, root.Docusign.MergeField, root.Docusign.PropertyMetadata, root.Docusign.SmartContractInformation);
  }
}(this, (ApiClient, ErrorDetails, LocalePolicyTab, MergeField, PropertyMetadata, SmartContractInformation) => {
  /**
   * The CommissionNumber model module.
   * @module model/CommissionNumber
   */

  /**
   * Constructs a new <code>CommissionNumber</code>.
   * @alias module:model/CommissionNumber
   * @class
   */
  ...
  /**
   * Constructs a <code>CommissionNumber</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CommissionNumber} obj Optional instance to populate.
   * @return {module:model/CommissionNumber} The populated <code>CommissionNumber</code> instance.
   */
