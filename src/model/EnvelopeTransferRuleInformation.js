...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EnvelopeTransferRule'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EnvelopeTransferRule'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    root.Docusign.EnvelopeTransferRuleInformation = factory(root.Docusign.ApiClient, root.Docusign.EnvelopeTransferRule);
  }
}(this, function(ApiClient, EnvelopeTransferRule) {
  'use strict';


  /**
   * The EnvelopeTransferRuleInformation model module.
   * @module model/EnvelopeTransferRuleInformation
   */

  /**
   * Constructs a new <code>EnvelopeTransferRuleInformation</code>.
   * @alias module:model/EnvelopeTransferRuleInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>EnvelopeTransferRuleInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EnvelopeTransferRuleInformation} obj Optional instance to populate.
   * @return {module:model/EnvelopeTransferRuleInformation} The populated <code>EnvelopeTransferRuleInformation</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('envelopeTransferRules')) {
        obj['envelopeTransferRules'] = ApiClient.convertToType(data['envelopeTransferRules'], [EnvelopeTransferRule]);
      }
  ...
  /**
   * 
   * @member {Array.<module:model/EnvelopeTransferRule>} envelopeTransferRules
   */
  exports.prototype['envelopeTransferRules'] = undefined;
  /**
