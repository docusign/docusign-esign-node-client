...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BulkEnvelopeStatus'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BulkEnvelopeStatus'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    root.Docusign.BulkEnvelopesResponse = factory(root.Docusign.ApiClient, root.Docusign.BulkEnvelopeStatus);
  }
}(this, function(ApiClient, BulkEnvelopeStatus) {
  'use strict';
  ...
  /**
   * Constructs a new <code>BulkEnvelopesResponse</code>.
   * @alias module:model/BulkEnvelopesResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>BulkEnvelopesResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BulkEnvelopesResponse} obj Optional instance to populate.
   * @return {module:model/BulkEnvelopesResponse} The populated <code>BulkEnvelopesResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('bulkEnvelopeStatuses')) {
        obj['bulkEnvelopeStatuses'] = ApiClient.convertToType(data['bulkEnvelopeStatuses'], [BulkEnvelopeStatus]);
      }
  ...
  /**
   * Reserved: TBD
   * @member {Array.<module:model/BulkEnvelopeStatus>} bulkEnvelopeStatuses
   */
  exports.prototype['bulkEnvelopeStatuses'] = undefined;
  /**
