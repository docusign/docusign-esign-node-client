...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/RecipientEmailNotification', 'model/Tabs'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./RecipientEmailNotification'), require('./Tabs'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    root.Docusign.TemplateRole = factory(root.Docusign.ApiClient, root.Docusign.RecipientEmailNotification, root.Docusign.Tabs);
  }
}(this, function(ApiClient, RecipientEmailNotification, Tabs) {
  'use strict';
