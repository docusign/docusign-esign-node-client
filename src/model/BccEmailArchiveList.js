...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BccEmailArchive'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BccEmailArchive'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    root.Docusign.BccEmailArchiveList = factory(root.Docusign.ApiClient, root.Docusign.BccEmailArchive);
  }
}(this, function(ApiClient, BccEmailArchive) {
  'use strict';
  ...
  /**
   * Constructs a <code>BccEmailArchiveList</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BccEmailArchiveList} obj Optional instance to populate.
   * @return {module:model/BccEmailArchiveList} The populated <code>BccEmailArchiveList</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('bccEmailArchives')) {
        obj['bccEmailArchives'] = ApiClient.convertToType(data['bccEmailArchives'], [BccEmailArchive]);
      }
  ...
  /**
   * 
   * @member {Array.<module:model/BccEmailArchive>} bccEmailArchives
   */
  exports.prototype['bccEmailArchives'] = undefined;
  /**
