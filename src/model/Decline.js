...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Docusign.Decline = factory(root.Docusign.ApiClient, root.Docusign.ErrorDetails, root.Docusign.LocalePolicyTab, root.Docusign.MergeField, root.Docusign.PropertyMetadata, root.Docusign.SmartContractInformation);
  }
  ...
  exports.constructFromObject = function (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('declineReasonMetadata')) {
        obj.declineReasonMetadata = PropertyMetadata.constructFromObject(data.declineReasonMetadata);
      }
