...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Docusign.NotaryCertificate = factory(root.Docusign.ApiClient, root.Docusign.ErrorDetails, root.Docusign.MergeField, root.Docusign.PropertyMetadata, root.Docusign.SmartContractInformation);
  }
}(this, (ApiClient, ErrorDetails, MergeField, PropertyMetadata, SmartContractInformation) => {
  /**
   * The NotaryCertificate model module.
   * @module model/NotaryCertificate
   */

  /**
   * Constructs a new <code>NotaryCertificate</code>.
   * @alias module:model/NotaryCertificate
   * @class
   */
  ...
  /**
   * Constructs a <code>NotaryCertificate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NotaryCertificate} obj Optional instance to populate.
   * @return {module:model/NotaryCertificate} The populated <code>NotaryCertificate</code> instance.
   */
