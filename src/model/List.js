...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorDetails', 'model/ListItem', 'model/LocalePolicyTab', 'model/MergeField', 'model/PropertyMetadata'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ErrorDetails'), require('./ListItem'), require('./LocalePolicyTab'), require('./MergeField'), require('./PropertyMetadata'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    root.Docusign.List = factory(root.Docusign.ApiClient, root.Docusign.ErrorDetails, root.Docusign.ListItem, root.Docusign.LocalePolicyTab, root.Docusign.MergeField, root.Docusign.PropertyMetadata);
  }
}(this, function(ApiClient, ErrorDetails, ListItem, LocalePolicyTab, MergeField, PropertyMetadata) {
  'use strict';
