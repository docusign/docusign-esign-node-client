...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/NotaryJurisdiction'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./NotaryJurisdiction'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    root.Docusign.NotaryJurisdictionList = factory(root.Docusign.ApiClient, root.Docusign.NotaryJurisdiction);
  }
}(this, function(ApiClient, NotaryJurisdiction) {
  'use strict';
  ...
  /**
   * Constructs a <code>NotaryJurisdictionList</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NotaryJurisdictionList} obj Optional instance to populate.
   * @return {module:model/NotaryJurisdictionList} The populated <code>NotaryJurisdictionList</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('notaryJurisdictions')) {
        obj['notaryJurisdictions'] = ApiClient.convertToType(data['notaryJurisdictions'], [NotaryJurisdiction]);
      }
  ...
  /**
   * 
   * @member {Array.<module:model/NotaryJurisdiction>} notaryJurisdictions
   */
  exports.prototype['notaryJurisdictions'] = undefined;
  /**
