...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GroupUserInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GroupUserInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    root.Docusign.GroupUsersResponse = factory(root.Docusign.ApiClient, root.Docusign.GroupUserInfo);
  }
}(this, function(ApiClient, GroupUserInfo) {
  'use strict';


  /**
   * The GroupUsersResponse model module.
   * @module model/GroupUsersResponse
   */

  /**
   * Constructs a new <code>GroupUsersResponse</code>.
   * @alias module:model/GroupUsersResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>GroupUsersResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GroupUsersResponse} obj Optional instance to populate.
   * @return {module:model/GroupUsersResponse} The populated <code>GroupUsersResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('users')) {
        obj['users'] = ApiClient.convertToType(data['users'], [GroupUserInfo]);
      }
    }
    return obj;
  }
  ...
  /**
   * 
   * @member {Array.<module:model/GroupUserInfo>} users
   */
