...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DateStampProperties', 'model/ErrorDetails', 'model/SignatureGroup', 'model/SignatureUser'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DateStampProperties'), require('./ErrorDetails'), require('./SignatureGroup'), require('./SignatureUser'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    root.Docusign.AccountSignature = factory(root.Docusign.ApiClient, root.Docusign.DateStampProperties, root.Docusign.ErrorDetails, root.Docusign.SignatureGroup, root.Docusign.SignatureUser);
  }
}(this, function(ApiClient, DateStampProperties, ErrorDetails, SignatureGroup, SignatureUser) {
  'use strict';


  /**
   * The AccountSignature model module.
   * @module model/AccountSignature
   */

  /**
   * Constructs a new <code>AccountSignature</code>.
   * @alias module:model/AccountSignature
   * @class
   */
  ...
  /**
   * Constructs a <code>AccountSignature</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AccountSignature} obj Optional instance to populate.
   * @return {module:model/AccountSignature} The populated <code>AccountSignature</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('signatureGroups')) {
        obj['signatureGroups'] = ApiClient.convertToType(data['signatureGroups'], [SignatureGroup]);
      }
      ...
      if (data.hasOwnProperty('signatureUsers')) {
        obj['signatureUsers'] = ApiClient.convertToType(data['signatureUsers'], [SignatureUser]);
      }
  ...
  /**
   * 
   * @member {Array.<module:model/SignatureGroup>} signatureGroups
   */
  ...
  /**
   * 
   * @member {Array.<module:model/SignatureUser>} signatureUsers
   */
