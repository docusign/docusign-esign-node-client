(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define([undefined, './Attachment', './CompositeTemplate', './CustomFields', './Document', './EmailSettings', './EventNotification', './LockInformation', './Notification', './Recipients', './TemplateRole'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(undefined, require('./Attachment'), require('./CompositeTemplate'), require('./CustomFields'), require('./Document'), require('./EmailSettings'), require('./EventNotification'), require('./LockInformation'), require('./Notification'), require('./Recipients'), require('./TemplateRole'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    factory(root.Docusign, root.Docusign.Attachment, root.Docusign.CompositeTemplate, root.Docusign.CustomFields, root.Docusign.Document, root.Docusign.EmailSettings, root.Docusign.EventNotification, root.Docusign.LockInformation, root.Docusign.Notification, root.Docusign.Recipients, root.Docusign.TemplateRole);
  }
}(this, function(module, Attachment, CompositeTemplate, CustomFields, Document, EmailSettings, EventNotification, LockInformation, Notification, Recipients, TemplateRole) {
  'use strict';
