...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompositeTemplate', 'model/CustomFields', 'model/Document', 'model/EmailSettings', 'model/EventNotification', 'model/LockInformation', 'model/Notification', 'model/Recipients', 'model/TemplateRole'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompositeTemplate'), require('./CustomFields'), require('./Document'), require('./EmailSettings'), require('./EventNotification'), require('./LockInformation'), require('./Notification'), require('./Recipients'), require('./TemplateRole'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    root.Docusign.EnvelopeDefinition = factory(root.Docusign.ApiClient, root.Docusign.CompositeTemplate, root.Docusign.CustomFields, root.Docusign.Document, root.Docusign.EmailSettings, root.Docusign.EventNotification, root.Docusign.LockInformation, root.Docusign.Notification, root.Docusign.Recipients, root.Docusign.TemplateRole);
  }
}(this, function(ApiClient, CompositeTemplate, CustomFields, Document, EmailSettings, EventNotification, LockInformation, Notification, Recipients, TemplateRole) {
  'use strict';
