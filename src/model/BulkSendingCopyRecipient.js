...
}(this, (ApiClient, BulkSendingCopyTab, IdCheckInformationInput, RecipientEmailNotification, RecipientPhoneAuthentication, RecipientSMSAuthentication, RecipientSignatureProvider, SocialAuthentication) => {
  /**
