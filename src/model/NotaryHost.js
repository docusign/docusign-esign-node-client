(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define([undefined, './AuthenticationStatus', './ErrorDetails', './IdCheckInformationInput', './PropertyMetadata', './RecipientAttachment', './RecipientEmailNotification', './RecipientPhoneAuthentication', './RecipientSAMLAuthentication', './RecipientSMSAuthentication', './SocialAuthentication'], factory);
    ...
    factory(root.Docusign, root.Docusign.AuthenticationStatus, root.Docusign.ErrorDetails, root.Docusign.IdCheckInformationInput, root.Docusign.PropertyMetadata, root.Docusign.RecipientAttachment, root.Docusign.RecipientEmailNotification, root.Docusign.RecipientPhoneAuthentication, root.Docusign.RecipientSAMLAuthentication, root.Docusign.RecipientSMSAuthentication, root.Docusign.SocialAuthentication);
  }
}(this, function(module, AuthenticationStatus, ErrorDetails, IdCheckInformationInput, PropertyMetadata, RecipientAttachment, RecipientEmailNotification, RecipientPhoneAuthentication, RecipientSAMLAuthentication, RecipientSMSAuthentication, SocialAuthentication) {
  'use strict';
  ...
  var NotaryHost = function NotaryHost() { 
    var self = this;
    ...
    self.constructFromObject = function(data) {
      ...
      if (data.notaryNameMetadata) {
        self.notaryNameMetadata = new data.notaryNameMetadata.constructor();
        self.notaryNameMetadata.constructFromObject(data.notaryNameMetadata);
      }
      ...
      if (data.notaryEmailMetadata) {
        self.notaryEmailMetadata = new data.notaryEmailMetadata.constructor();
        self.notaryEmailMetadata.constructFromObject(data.notaryEmailMetadata);
      }
      
      if (data.hostRecipientId) {
        self.hostRecipientId = data.hostRecipientId;
      }
     ...
     **/
    self.getNotaryNameMetadata = function() {
      return self.notaryNameMetadata;
    }

    /**
     * @param {PropertyMetadata} notaryNameMetadata
     **/
    self.setNotaryNameMetadata = function (notaryNameMetadata) {
      self.notaryNameMetadata = notaryNameMetadata;
    }
     ...
     * @return {PropertyMetadata}
     **/
    self.getNotaryEmailMetadata = function() {
      return self.notaryEmailMetadata;
    }

    /**
     * @param {PropertyMetadata} notaryEmailMetadata
     **/
    self.setNotaryEmailMetadata = function (notaryEmailMetadata) {
      self.notaryEmailMetadata = notaryEmailMetadata;
    }
     ...
     * @return {String}
     **/
    self.getHostRecipientId = function() {
      return self.hostRecipientId;
    }
     ...
     **/
    self.setHostRecipientId = function (hostRecipientId) {
