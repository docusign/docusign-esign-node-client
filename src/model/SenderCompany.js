...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Docusign.SenderCompany = factory(root.Docusign.ApiClient, root.Docusign.ConnectedObjectDetails, root.Docusign.ErrorDetails, root.Docusign.ExtensionData, root.Docusign.LocalePolicyTab, root.Docusign.MergeField, root.Docusign.PropertyMetadata, root.Docusign.SmartContractInformation);
  }
  ...
  /**
   * The SenderCompany model module.
   * @module model/SenderCompany
   */

  /**
   * Constructs a new <code>SenderCompany</code>.
   * @alias module:model/SenderCompany
   * @class
   */
  ...
  /**
   * Constructs a <code>SenderCompany</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SenderCompany} obj Optional instance to populate.
   * @return {module:model/SenderCompany} The populated <code>SenderCompany</code> instance.
   */
