...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Envelope', 'model/EnvelopeTransactionStatus'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Envelope'), require('./EnvelopeTransactionStatus'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    root.Docusign.EnvelopesInformation = factory(root.Docusign.ApiClient, root.Docusign.Envelope, root.Docusign.EnvelopeTransactionStatus);
  }
}(this, function(ApiClient, Envelope, EnvelopeTransactionStatus) {
  'use strict';
