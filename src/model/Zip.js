...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Docusign.Zip = factory(root.Docusign.ApiClient, root.Docusign.ErrorDetails, root.Docusign.LocalePolicyTab, root.Docusign.MergeField, root.Docusign.PropertyMetadata, root.Docusign.SmartContractInformation);
  }
  ...
  exports.constructFromObject = function (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('useDash4')) {
        obj.useDash4 = ApiClient.convertToType(data.useDash4, 'String');
      }
      if (data.hasOwnProperty('useDash4Metadata')) {
        obj.useDash4Metadata = PropertyMetadata.constructFromObject(data.useDash4Metadata);
      }
   ...
   */
  exports.prototype.useDash4 = undefined;
  /**
   * @member {module:model/PropertyMetadata} useDash4Metadata
   */
  exports.prototype.useDash4Metadata = undefined;
  /**
