...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('isPartOfDomain')) {
        obj['isPartOfDomain'] = ApiClient.convertToType(data['isPartOfDomain'], 'String');
      }
  ...
  /**
   * 
   * @member {String} isPartOfDomain
   */
  exports.prototype['isPartOfDomain'] = undefined;
  /**
   * 
