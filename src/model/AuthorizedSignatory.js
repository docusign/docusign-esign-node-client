...
(function(root, factory) {
  ...
  /**
   * The AuthorizedSignatory model module.
   * @module model/AuthorizedSignatory
   */

  /**
   * Constructs a new <code>AuthorizedSignatory</code>.
   * @alias module:model/AuthorizedSignatory
   * @class
   */
  ...
  /**
   * Constructs a <code>AuthorizedSignatory</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AuthorizedSignatory} obj Optional instance to populate.
   * @return {module:model/AuthorizedSignatory} The populated <code>AuthorizedSignatory</code> instance.
   */
