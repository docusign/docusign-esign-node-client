...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/NotaryJournal'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./NotaryJournal'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    root.Docusign.NotaryJournalList = factory(root.Docusign.ApiClient, root.Docusign.NotaryJournal);
  }
}(this, function(ApiClient, NotaryJournal) {
  'use strict';
  ...
  /**
   * Constructs a new <code>NotaryJournalList</code>.
   * @alias module:model/NotaryJournalList
   * @class
   */
  ...
  /**
   * Constructs a <code>NotaryJournalList</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NotaryJournalList} obj Optional instance to populate.
   * @return {module:model/NotaryJournalList} The populated <code>NotaryJournalList</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('notaryJournals')) {
        obj['notaryJournals'] = ApiClient.convertToType(data['notaryJournals'], [NotaryJournal]);
      }
  ...
  /**
   * 
   * @member {Array.<module:model/NotaryJournal>} notaryJournals
   */
  exports.prototype['notaryJournals'] = undefined;
  /**
