...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ConnectedObjectDetails', 'model/ErrorDetails', 'model/ExtensionData', 'model/MergeField', 'model/PropertyMetadata', 'model/SmartContractInformation'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ConnectedObjectDetails'), require('./ErrorDetails'), require('./ExtensionData'), require('./MergeField'), require('./PropertyMetadata'), require('./SmartContractInformation'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    root.Docusign.Draw = factory(root.Docusign.ApiClient, root.Docusign.ConnectedObjectDetails, root.Docusign.ErrorDetails, root.Docusign.ExtensionData, root.Docusign.MergeField, root.Docusign.PropertyMetadata, root.Docusign.SmartContractInformation);
  }
}(this, function(ApiClient, ConnectedObjectDetails, ErrorDetails, ExtensionData, MergeField, PropertyMetadata, SmartContractInformation) {
  'use strict';
  ...
  /**
   * Constructs a <code>Draw</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Draw} obj Optional instance to populate.
   * @return {module:model/Draw} The populated <code>Draw</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('allowSignerUpload')) {
        obj['allowSignerUpload'] = ApiClient.convertToType(data['allowSignerUpload'], 'String');
      }
      ...
      if (data.hasOwnProperty('useBackgroundAsCanvas')) {
        obj['useBackgroundAsCanvas'] = ApiClient.convertToType(data['useBackgroundAsCanvas'], 'String');
      }
  ...
  /**
   * 
   * @member {String} allowSignerUpload
   */
  exports.prototype['allowSignerUpload'] = undefined;
  /**
   * 
  ...
  /**
   * 
   * @member {String} useBackgroundAsCanvas
   */
  exports.prototype['useBackgroundAsCanvas'] = undefined;
  /**
   * 
