...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Docusign.PageImages = factory(root.Docusign.ApiClient, root.Docusign.Page);
  }
  ...
  /**
   * Constructs a new <code>PageImages</code>.
   * @alias module:model/PageImages
   * @class
   */
  ...
  /**
   * Constructs a <code>PageImages</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageImages} obj Optional instance to populate.
   * @return {module:model/PageImages} The populated <code>PageImages</code> instance.
   */
