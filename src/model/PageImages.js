(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define([undefined, './Page'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(undefined, require('./Page'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    factory(root.Docusign, root.Docusign.Page);
  }
}(this, function(module, Page) {
  'use strict';
  ...
  var PageImages = function PageImages() { 
    var self = this;
