...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Agent', 'model/AuthorizedSignatory', 'model/CarbonCopy', 'model/CertifiedDelivery', 'model/Editor', 'model/ErrorDetails', 'model/InPersonSigner', 'model/Intermediary', 'model/NotaryRecipient', 'model/NotaryWitness', 'model/Participant', 'model/SealSign', 'model/Signer', 'model/Witness'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Agent'), require('./AuthorizedSignatory'), require('./CarbonCopy'), require('./CertifiedDelivery'), require('./Editor'), require('./ErrorDetails'), require('./InPersonSigner'), require('./Intermediary'), require('./NotaryRecipient'), require('./NotaryWitness'), require('./Participant'), require('./SealSign'), require('./Signer'), require('./Witness'));
  } else {
    // Browser globals (root is window)
    if (!root.Docusign) {
      root.Docusign = {};
    }
    root.Docusign.TemplateRecipients = factory(root.Docusign.ApiClient, root.Docusign.Agent, root.Docusign.AuthorizedSignatory, root.Docusign.CarbonCopy, root.Docusign.CertifiedDelivery, root.Docusign.Editor, root.Docusign.ErrorDetails, root.Docusign.InPersonSigner, root.Docusign.Intermediary, root.Docusign.NotaryRecipient, root.Docusign.NotaryWitness, root.Docusign.Participant, root.Docusign.SealSign, root.Docusign.Signer, root.Docusign.Witness);
  }
}(this, function(ApiClient, Agent, AuthorizedSignatory, CarbonCopy, CertifiedDelivery, Editor, ErrorDetails, InPersonSigner, Intermediary, NotaryRecipient, NotaryWitness, Participant, SealSign, Signer, Witness) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('authorizedSignatories')) {
        obj['authorizedSignatories'] = ApiClient.convertToType(data['authorizedSignatories'], [AuthorizedSignatory]);
      }
      ...
      if (data.hasOwnProperty('notaryWitnesses')) {
        obj['notaryWitnesses'] = ApiClient.convertToType(data['notaryWitnesses'], [NotaryWitness]);
      }
  ...
  /**
   * 
   * @member {Array.<module:model/AuthorizedSignatory>} authorizedSignatories
   */
  exports.prototype['authorizedSignatories'] = undefined;
  /**
  ...
  /**
   * 
   * @member {Array.<module:model/NotaryWitness>} notaryWitnesses
   */
  exports.prototype['notaryWitnesses'] = undefined;
  /**
   * 
