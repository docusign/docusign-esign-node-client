...
(function(root, factory) {
  ...
  /**
   * The NotaryWitness model module.
   * @module model/NotaryWitness
   */

  /**
   * Constructs a new <code>NotaryWitness</code>.
   * @alias module:model/NotaryWitness
   * @class
   */
  ...
  /**
   * Constructs a <code>NotaryWitness</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NotaryWitness} obj Optional instance to populate.
   * @return {module:model/NotaryWitness} The populated <code>NotaryWitness</code> instance.
   */
