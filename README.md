...
$ npm run test 
```
If you are running the tests for the first time, you may need to grant permission to the application to make API calls. You can do this by opening OAuth authorization url from terminal output and pressing Accept button.
